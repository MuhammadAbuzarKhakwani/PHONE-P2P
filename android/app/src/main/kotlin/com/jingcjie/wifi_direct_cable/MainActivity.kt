...
import com.jingcjie.wifi_direct_cable.session.MethodChannelPairingPrompt
...
class MainActivity : FlutterActivity(), WiFiDirectManager.ConnectionListener {
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        // Supplying a real prompt is what makes the app advertise the v3
        // secure capability at all; with the default refusing prompt both
        // peers agree to stay on the plaintext v2 channel.
        sessionManager = SessionManager(
            context = this,
            methodChannel = methodChannel,
            pairingPrompt = MethodChannelPairingPrompt(methodChannel)
        )
